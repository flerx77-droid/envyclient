...
Discord: при каждом релизе пост в #обновления уходит автоматически (GitHub Actions → вебхук).
Тестовое сообщение можно отправить вручную: Actions → Discord Release → Run workflow.
